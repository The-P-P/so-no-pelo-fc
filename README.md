...
8. Execute a migration `supabase/migrations/020_push_subscriptions.sql` **somente se** a tabela `push_subscriptions` ainda não existir (o `schema.sql` já inclui essa tabela — rodar os dois de novo só é seguro com a migration idempotente)
